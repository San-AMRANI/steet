...
final studentProvider = FutureProvider.autoDispose.family<Student?, String>((ref, id) async {
...
final updateStudentProvider = FutureProvider.autoDispose.family<Student?, Student>((ref, student) async {
