class ApiEndpoints {
  ...
  static const String studentCount = '/api/students/countByactive';

  /// GET: Retrieve the count of active students
  /// Returns the count of active students in the system

  static const String allStudents = '/api/students/allstudents';
  ...
  static const String getProfileImage =
      '/api/students/profile-image/{fileName}';
  ...
  static const String allPrvRooms = '/privateRooms/all';
  ...
  static const String privateRoomsByCreator =
      '/privateRooms/creator/{studentId}';
  ...
  static const String membershipsByStudentId =
  ...
  static const String participationsByStudentId =
